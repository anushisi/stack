             ...
             <form onSubmit={handleSubmit}>
                <div className="ask-form-container">
                    <label htmlFor="ask-ques-title">
                        ...
                        <input type="text" id="ask-ques-title"  onChange={(e)=>{setQuestionTitle(e.target.value)}} placeholder="e.g.How to create a react app"/>
                    </label>
                    ...
                    <label htmlFor="ask-ques-tags">
                        ...
                        <input type="text" id="ask-ques-tags" onChange={(e)=>{setQuestionTags(e.target.value.split(" "))}} placeholder="e.g.React,Nodejs"/>
                    </label>
                </div>
